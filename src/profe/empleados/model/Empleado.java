...
public class Empleado implements Serializable, Comparable<Empleado> {
	...
	private Set<Nomina> nominasEmpleado;
	...
	public Set<Nomina> getNominasEmpleado() {
		return nominasEmpleado;
	}

	public void setNominasEmpleado(Set<Nomina> nominasEmpleado) {
		this.nominasEmpleado = nominasEmpleado;
	}
